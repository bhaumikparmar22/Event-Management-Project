...
def forgot_password(request):
	if request.method=="POST":
		try:
			...
			querystring = {"authorization":"cmMw2Ed6ZG8Ak1uQnWJxIBfg9e4hplvqV7yFLYSU3aijtKNTzC6UaiBNDxfKCM7rZ8F2kSOuwdpGePhT","variables_values":otp,"route":"otp","numbers":mobile}
